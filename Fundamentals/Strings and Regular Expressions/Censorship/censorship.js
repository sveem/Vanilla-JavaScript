 ...
 */
 ...
 const censorship = input => {
   ...
   for (let strings of input) {
     let censored = new RegExp(strings, 'g');
     text = text.replace(censored, match =>'-'.repeat(Number(match.length)));
   }
   return text;
 };

 console.log(censorship(input1));
 console.log(censorship(input2));